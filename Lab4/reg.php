 ...
 if(isset($_POST['submit']))
 {
        ...
        if(!empty($name)){
            ...
            if(count(explode(" ",$name)  )< 2) {
              ...
              echo "<center> Username should contain at least two words </center> ";
              $msg = "Provide a valid name";

              header("location: registration.php?name=".$msg);
        ...
        if(!empty($password)){
          ...
          if(strlen($password) <= 8) {
            ...
            header("location: registration.php?password=".$msg);
        ...
        {
          echo "<center> null submission </center> ";
        }
